...
public class Day12 {
    public static void execute() {
        ...
        try {
            ...
            System.out.println(n.getName() + n.getShortestPath());
            System.out.println("Day 12 - Question 2: "  + n.getShortestPath().size());
            System.out.println("Day 12 - Question 2: " );
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
...
class Node {
    ...
    public void print() {
        ...
        System.out.print(shortestPath.size());
